%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For the nonlinear least square algorithm, it has non-fixed initial point
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while tot_num_localization <= 50
    ...
    while dr_move < 720        
        ...
        % nonlinear
        fun = @(x)(20*log10(dist_meas) - 20*log10(sqrt(sum(abs([l_DR(dr_move,1) l_DR(dr_move,2)] - [x(1) x(2)]).^2,2)))).^2
